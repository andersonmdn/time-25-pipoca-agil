...
export const nameSchema = z.string().trim().min(2).max(100) // nome válido
export const optionalTrimSchema = z.string().trim().optional().nullable() // string opcional (não obrigatório, aceita null)
